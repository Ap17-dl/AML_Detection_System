  ...
  try {
    ...
    return (
      <div className="bg-brand-bgLight dark:bg-bg flex min-h-screen items-center justify-center p-8">
        <div className="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-8 text-center shadow-xl backdrop-blur-md dark:border-slate-800 dark:bg-slate-900/80">
          ...
          <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">
            The surveillance service may be initializing or your session needs
            to be refreshed.
          </p>
          <div className="mt-6 flex flex-col gap-3">
            <a
              href="/login"
              className="bg-gold hover:bg-gold-dark text-brand-dark inline-flex items-center justify-center gap-2 rounded-xl px-5 py-2.5 text-sm font-semibold shadow-sm transition-colors"
            >
            ...
            <a
              href="/dashboard"
              className="inline-flex items-center justify-center gap-2 rounded-xl border border-slate-200 bg-transparent px-5 py-2.5 text-sm font-medium text-slate-700 transition-colors hover:bg-slate-100 dark:border-slate-700 dark:text-slate-300 dark:hover:bg-slate-800/60"
            >
